...
def test_phase3_uncertainty():
    ...
    # Test ConformalPredictor with our XGBSpreadModel
    try:
        ...
        results['ConformalPredictor'] = 'OK'
        print(f"  ConformalPredictor: OK")
        print(f"    Interval width mean: {(upper - lower).mean():.4f}")

    except Exception as e:
        results['ConformalPredictor'] = f'FAIL: {e}'
        print(f"  ConformalPredictor: FAIL - {e}")
    ...
    try:
        ...
        results['AdaptiveConformalPredictor'] = 'OK'
        print(f"  AdaptiveConformalPredictor: OK")

    except Exception as e:
        results['AdaptiveConformalPredictor'] = f'FAIL: {e}'
        print(f"  AdaptiveConformalPredictor: FAIL - {e}")
...
def test_phase4_regime():
    ...
    try:
        ...
        results['OnlineUpdater'] = f'OK (retrain: {should_retrain})'
        print(f"  OnlineUpdater: OK")
        print(f"    Should retrain: {should_retrain}")
        print(f"    Reason: {reason}")

    except Exception as e:
        results['OnlineUpdater'] = f'FAIL: {e}'
        print(f"  OnlineUpdater: FAIL - {e}")
